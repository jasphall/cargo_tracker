...
import static com.jasphall.cargo_tracker.domain.model.location.SampleLocations.*;
import static com.jasphall.cargo_tracker.application.util.DateUtil.*;

/**
 * Przykładowe przeprawy z punktu do punktu, na potrzeby testów
 */
public class SampleVoyages {
    ...
    private static Voyage createVoyage(String id, Location from, Location to) {
        return new Voyage(new VoyageNumber(id), new VoyageSchedule(
